          ...
          <form onSubmit={handleSubmit} className="w-full space-y-8">
            ...
            <div className="overflow-hidden rounded-[8px] border border-[#d9d9d9] bg-white shadow-sm">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#ededed] p-4">
                ...
                <select name="bagType" value={formData.bagType} onChange={handleInputChange} className="h-[40px] flex-1 rounded-[5px] border border-[#d8d8d8] bg-white px-3 text-sm outline-none">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#ededed] p-4">
                ...
                <div className="flex flex-1 items-center gap-4">
                  <input type="number" name="quantity" value={formData.quantity} onChange={handleInputChange} min="1000" className="h-[40px] w-[110px] rounded-[5px] border border-[#d8d8d8] px-3 text-center outline-none focus:border-[#1f73ff]" />
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#ededed] p-4">
                ...
                <select name="bagSize" value={formData.bagSize} onChange={handleInputChange} className="h-[40px] flex-1 rounded-[5px] border border-[#d8d8d8] bg-white px-3 text-sm outline-none">
                  {bagSizes.map((size) => (
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#ededed] p-4">
                ...
                <select name="bagColor" value={formData.bagColor} onChange={handleInputChange} className="h-[40px] flex-1 rounded-[5px] border border-[#d8d8d8] bg-white px-3 text-sm outline-none">
                  {bagColors.map((color) => (
              ...
              <div className="divide-y divide-[#ededed]">
                ...
                <div className="flex items-center justify-between px-4 py-4 text-[15px]">
                  <span>Valid PDF</span>
                  <span className={`font-bold ${uploadedDesignType === "PDF" ? "text-[#059669]" : "text-[#64748b]"}`}>{uploadedDesignType === "PDF" ? "Yes" : "No"}</span>
                </div>
                <div className="flex items-center justify-between px-4 py-4 text-[15px]">
                ...
                <div className="flex items-center gap-3 px-4 py-4">
                  ...
                  <input type="number" name="sellingPrice" value={formData.sellingPrice} onChange={handleInputChange} className="h-[40px] w-[120px] rounded-[5px] border border-[#d8d8d8] px-3 outline-none" />
