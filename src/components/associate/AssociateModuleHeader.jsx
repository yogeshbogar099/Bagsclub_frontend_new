        ...
        <div className="grid gap-4 py-3 lg:grid-cols-[240px_minmax(0,1fr)_320px] lg:items-center box-border">
          ...
          <div className="min-w-0 text-center box-border flex flex-col items-center justify-center">
            <div className="space-y-0.5 box-border">
              <p className="text-[14px] leading-[1.42] font-bold text-[#111] box-border">{headerData?.systemName || "Printing Services Division"}</p>
              <p className="text-[13px] leading-[1.42] text-[#333] box-border">
                Go to{" "}
                <button
                  type="button"
                  onClick={() => navigateTo("/")}
                  className="font-bold text-[#0044cc] transition hover:text-[#a71a00] hover:underline box-border"
                >
                  All Services
                </button>
              </p>
              <div className="flex flex-col items-center justify-center gap-0.5 pt-0.5 box-border">
                <p className="text-[12px] leading-[1.42] text-[#444] box-border flex items-center justify-center gap-1.5">
                  Printers Registered with Us (India):{" "}
                ...
                <p className="text-[12px] leading-[1.42] text-[#444] box-border flex items-center justify-center gap-1.5">
                  Printers Registered with Us (Outside India):{" "}
                  <span className="bg-[#fce8e6] text-[#b30000] px-1.5 py-0 rounded text-[12px] font-bold">
                    0
                  </span>{" "}
                  & increasing...
          ...
          <div className="flex min-w-0 items-center justify-center lg:justify-end box-border">
            <div className="flex w-full max-w-[360px] items-center justify-between gap-3 rounded border border-[#e0e2e7] bg-white px-3 py-2 shadow-[0_1px_3px_rgba(15,23,42,0.06)] box-border">
              <div className="flex items-center gap-2 min-w-0">
                <div className="rounded-full bg-[#a71a00] p-1.5 text-white shrink-0 box-border">
                  <UserCircle2 size={16} />
                </div>
                <div className="min-w-0 text-left text-[14px] leading-[1.35] text-[#5c5c5c] box-border">
                  ...
                  <div className="inline-flex flex-wrap items-center gap-1.5 font-bold text-[#8f4d43] box-border">
                    <span className="inline-flex items-center gap-1 box-border">
                      <Wallet size={14} />
              ...
              <button
                ...
                className="shrink-0 rounded border border-[#f0c8bd] bg-white px-3 py-1.5 text-[13px] leading-[1.42] font-bold text-[#a71a00] transition hover:border-[#a71a00] hover:bg-[#fff7f4] box-border"
              >
                Sign Out
              </button>
            </div>
